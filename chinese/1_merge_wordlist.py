...
chinese_xlsx = pandas.DataFrame(columns=['Item'])
...
for filename in fileNamesSorted:
    ...
    chinese_xlsx = chinese_xlsx.append(wordlist)
chinese_xlsx.to_excel("1_merge_wordlist.xlsx", index=False, header=False)
pass